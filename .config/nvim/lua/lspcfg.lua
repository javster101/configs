...
out.load_keybinds = function(client, bufnr)
  ...
  vim.keymap.set('n', '<space>K', require("lspsaga.hover").render_hover_doc, opts)
  vim.keymap.set('n', 'gi', '<cmd>lua vim.lsp.buf.implementation()<CR>', opts)
  vim.keymap.set('n', '<C-k>', require("lspsaga.signaturehelp").signature_help, opts)
  vim.keymap.set('n', '<space>D', require("lspsaga.definition").preview_definition, opts)
